...
4. Adaptar a rotação, pontuação e linhas eliminadas, de acordo com a rotação
5. Arrumar pontuação do tabuleiro 22x44
6. Fixar canvas para não haver rolagem de página
